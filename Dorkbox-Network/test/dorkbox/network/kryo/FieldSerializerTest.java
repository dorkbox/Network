...
public class FieldSerializerTest extends KryoTestCase {
	...
	public void testOptionalRegistration () {
		...
		roundTrip(195-packageOffset-packageOffset, 215-packageOffset-packageOffset, test);
		test.hasStringField = null;
		roundTrip(193-packageOffset-packageOffset, 213-packageOffset-packageOffset, test);
		...
		roundTrip(140-packageOffset, 150-packageOffset, test);
		...
		// HACK offset by X from original because of changes in package name
		roundTrip(63-packageOffset, 73-packageOffset, c);
	}
	...
	public void testDefaultSerializerAnnotation () {
		kryo = new Kryo();
		// HACK offset by X from original because of changes in package name
		roundTrip(82-packageOffset, 89-packageOffset, new HasDefaultSerializerAnnotation(123));
	}
	...
	public void testOptionalAnnotation () {
		...
		roundTrip(72-packageOffset-2, 72-packageOffset-2, new HasOptionalAnnotation());
		kryo = new Kryo();
		kryo.getContext().put("smurf", null);
		// HACK offset by X from original because of changes in package name + 2 b/c of how optionalAnnotations works
		roundTrip(73-packageOffset-2, 76-packageOffset-2, new HasOptionalAnnotation());
	}
